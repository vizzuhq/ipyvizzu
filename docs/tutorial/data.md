...
should also be added as dimensions. By default, ipyvizzu will draw the elements
on the chart in the order they are provided in the data set. Thus we suggest
